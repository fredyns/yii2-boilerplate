...
class RgnPostcodeController extends Controller
{
	...
	public function actionIndex()
	{
		...
		if (RgnPostcodeControl::isAccessingIndexAllowed() == FALSE)
		{
			throw RgnPostcodeControl::accessException('index');
		}
	...
	/**
	 * Lists all deleted RgnPostcode models.
	 * @return mixed
	 */
	public function actionDeleted()
	{
		...
		if (RgnPostcodeControl::isAccessingDeletedAllowed() == FALSE)
		{
			throw RgnPostcodeControl::accessException('deleted');
		}
	...
	/**
	 * Restore deleted RgnPostcode model.
