...
/**
 * Description of CountryOperation
 *
 * @author fredy
 *
 ...
 */
class CountryOperation extends ModelOperation
{
	...
	public function getAllowDelete()
	{
		...
		if (array_key_exists('delete', $this->allowed) == FALSE)
		{
			...
			else if ($this->model->recordStatus == Country::RECORDSTATUS_DELETED)
			{
	...
	public function getAllowRestore()
	{
		...
		if (array_key_exists('restore', $this->allowed) == FALSE)
		{
			...
			else if ($this->model->recordStatus == Country::RECORDSTATUS_USED)
			{
