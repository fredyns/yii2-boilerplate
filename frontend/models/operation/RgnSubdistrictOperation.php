...
/**
 * Description of RgnSubdistrictOperation
 *
 * @author fredy
 *
 * @property RgnSubdistrict $model
 * @property Bool $allowRestore
 * @property Array $paramsRestore
 */
class RgnSubdistrictOperation extends ModelOperation
{
	...
	public function getAllowDelete()
	{
		...
		if (array_key_exists('delete', $this->allowed) == FALSE)
		{
			...
			else if ($this->model->recordStatus == RgnSubdistrict::RECORDSTATUS_DELETED)
			{
	...
	public function getAllowRestore()
	{
		...
		if (array_key_exists('restore', $this->allowed) == FALSE)
		{
			...
			else if ($this->model->recordStatus == RgnSubdistrict::RECORDSTATUS_USED)
			{
