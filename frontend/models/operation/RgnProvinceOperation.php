...
/**
 * Description of RgnProvinceOperation
 *
 * @author fredy
 *
 * @property RgnProvince $model
 * @property Bool $allowRestore
 * @property Array $paramsRestore
 */
class RgnProvinceOperation extends ModelOperation
{
	...
	public function getAllowDelete()
	{
		...
		if (array_key_exists('delete', $this->allowed) == FALSE)
		{
			...
			else if ($this->model->recordStatus == RgnProvince::RECORDSTATUS_DELETED)
			{
	...
	public function getAllowRestore()
	{
		...
		if (array_key_exists('restore', $this->allowed) == FALSE)
		{
			...
			else if ($this->model->recordStatus == RgnProvince::RECORDSTATUS_USED)
			{
