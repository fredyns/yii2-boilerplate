...
/**
 * Description of RgnCountryOperation
 *
 * @author fredy
 *
 * @property RgnCountry $model
 * @property Bool $allowRestore
 * @property Array $paramsRestore
 */
class RgnCountryOperation extends ModelOperation
{
	...
	public function getAllowDelete()
	{
		...
		if (array_key_exists('delete', $this->allowed) == FALSE)
		{
			...
			else if ($this->model->recordStatus == RgnCountry::RECORDSTATUS_DELETED)
			{
	...
	public function getAllowRestore()
	{
		...
		if (array_key_exists('restore', $this->allowed) == FALSE)
		{
			...
			else if ($this->model->recordStatus == RgnCountry::RECORDSTATUS_USED)
			{
